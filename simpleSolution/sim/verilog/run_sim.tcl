...
if {[file isfile TopSimple.autotvin.dat]} {
	file delete -force TopSimple.autotvin.dat
}

if {[file isfile TopSimple.autotvout.dat]} {
	file delete -force TopSimple.autotvout.dat
}

...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.TopSimple.autotvin_in1.dat"
         "c.TopSimple.autotvin_in2.dat"
         "c.TopSimple.autotvout_out_r.dat"
         "c.TopSimple.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.TopSimple.autotvout_out_r.dat"
         "rtl.TopSimple.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "TopSimple.autotvin.dat"
	set constFileTvOut       "TopSimple.autotvout.dat"
	set constFileHdlTvIn     "TopSimple.autohdltvin.dat"
	set constFileHdlTvOut    "TopSimple.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

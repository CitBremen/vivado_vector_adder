...
set Library     "hls"
set IPName      "TopSimple"
set Version     "1.0"
set DisplayName "Topsimple"
set Revision    "1605231239"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "in1 {base_address 32 range 16} in2 {base_address 48 range 16} out_r {base_address 64 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"

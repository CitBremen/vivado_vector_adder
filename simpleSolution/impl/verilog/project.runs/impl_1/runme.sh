...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/simpleSolution/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopSimple.vdi -applog -m64 -messageDb vivado.pb -mode batch -source TopSimple.tcl -notrace

...
`define AUTOTB_DUT      TopSimple
`define AUTOTB_DUT_INST AESL_inst_TopSimple
`define AUTOTB_TOP      apatb_TopSimple_top
`define AUTOTB_LAT_RESULT_FILE "TopSimple.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "TopSimple.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_TopSimple_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_TRANSACTION_NUM  1
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define LENGTH_in1 3
`define LENGTH_in2 3
`define LENGTH_out_r 3
`define LENGTH_ap_return 1

`define   AESL_DEPTH_in1 1
`define   AESL_DEPTH_in2 1
`define   AESL_DEPTH_out_r 1
`define AUTOTB_TVIN_in1  "./c.TopSimple.autotvin_in1.dat"
`define AUTOTB_TVIN_in2  "./c.TopSimple.autotvin_in2.dat"
`define AUTOTB_TVIN_in1_out_wrapc  "./rtl.TopSimple.autotvin_in1.dat"
`define AUTOTB_TVIN_in2_out_wrapc  "./rtl.TopSimple.autotvin_in2.dat"
`define AUTOTB_TVOUT_out_r  "./c.TopSimple.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return  "./c.TopSimple.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.TopSimple.autotvout_out_r.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.TopSimple.autotvout_ap_return.dat"
...
initial begin : generate_AESL_ready_cnt_proc
	...
	initial begin : finish_simulation
		...
		@ (posedge AESL_clock);
		@ (posedge AESL_clock);
    fp1 = $fopen("./rtl.TopSimple.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.TopSimple.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.TopSimple.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.TopSimple.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.TopSimple.autotvout_ap_return.dat with impl_rtl.TopSimple.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "TopAdder.autotvin.dat"
	set constFileTvOut       "TopAdder.autotvout.dat"
	set constFileHdlTvIn     "TopAdder.autohdltvin.dat"
	set constFileHdlTvOut    "TopAdder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

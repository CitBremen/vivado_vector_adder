...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.TopAdder.autotvin_input1_M_real.dat"
         "c.TopAdder.autotvin_input1_M_imag.dat"
         "c.TopAdder.autotvin_input2_M_real.dat"
         "c.TopAdder.autotvin_input2_M_imag.dat"
         "c.TopAdder.autotvout_output_M_real.dat"
         "c.TopAdder.autotvout_output_M_imag.dat"
         "c.TopAdder.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.TopAdder.autotvout_output_M_real.dat"
         "rtl.TopAdder.autotvout_output_M_imag.dat"
         "rtl.TopAdder.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
if {[file isfile TopAdder.autotvin.dat]} {
	file delete -force TopAdder.autotvin.dat
}

if {[file isfile TopAdder.autotvout.dat]} {
	file delete -force TopAdder.autotvout.dat
}

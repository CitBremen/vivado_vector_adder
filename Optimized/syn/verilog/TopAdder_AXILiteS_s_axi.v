...
#(parameter
    ...
    output wire [31:0]                   input1_M_real_q0,
    input  wire [3:0]                    input1_M_imag_address0,
    input  wire                          input1_M_imag_ce0,
    output wire [31:0]                   input1_M_imag_q0,
...
localparam
    ...
    ADDR_OUTPUT_M_REAL_BASE = 8'h20,
    ADDR_OUTPUT_M_REAL_HIGH = 8'h2f,
    ADDR_OUTPUT_M_IMAG_BASE = 8'h30,
    ADDR_OUTPUT_M_IMAG_HIGH = 8'h3f,
    ADDR_INPUT1_M_REAL_BASE = 8'h40,
    ADDR_INPUT1_M_REAL_HIGH = 8'h7f,
    ADDR_INPUT1_M_IMAG_BASE = 8'h80,
    ADDR_INPUT1_M_IMAG_HIGH = 8'hbf,
    ADDR_INPUT2_M_REAL_BASE = 8'hc0,
    ADDR_INPUT2_M_REAL_HIGH = 8'hcf,
    ADDR_INPUT2_M_IMAG_BASE = 8'hd0,
    ADDR_INPUT2_M_IMAG_HIGH = 8'hdf,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    RDIDLE                  = 2'd0,
...
//------------------------Local signal-------------------
    ...
    wire [3:0]                    int_input1_M_real_be0;
    wire [31:0]                   int_input1_M_real_d0;
    wire [31:0]                   int_input1_M_real_q0;
    wire [3:0]                    int_input1_M_real_address1;
    wire                          int_input1_M_real_ce1;
    wire                          int_input1_M_real_we1;
    wire [3:0]                    int_input1_M_real_be1;
    wire [31:0]                   int_input1_M_real_d1;
    wire [31:0]                   int_input1_M_real_q1;
    ...
    wire [3:0]                    int_input1_M_imag_be0;
    wire [31:0]                   int_input1_M_imag_d0;
    wire [31:0]                   int_input1_M_imag_q0;
    wire [3:0]                    int_input1_M_imag_address1;
    wire                          int_input1_M_imag_ce1;
    wire                          int_input1_M_imag_we1;
    wire [3:0]                    int_input1_M_imag_be1;
    wire [31:0]                   int_input1_M_imag_d1;
    wire [31:0]                   int_input1_M_imag_q1;
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            rdata <= int_input1_M_real_q1;
        end
        else if (int_input1_M_imag_read) begin
            rdata <= int_input1_M_imag_q1;
        end
...
assign int_input1_M_real_address1 = ar_hs? raddr[5:2] : waddr[5:2];
...
assign int_input1_M_real_be1      = WSTRB;
assign int_input1_M_real_d1       = WDATA;
// input1_M_imag
...
assign int_input1_M_imag_address1 = ar_hs? raddr[5:2] : waddr[5:2];
...
assign int_input1_M_imag_be1      = WSTRB;
assign int_input1_M_imag_d1       = WDATA;
// input2_M_real

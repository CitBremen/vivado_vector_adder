...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "output_M_real {base_address 32 range 16} output_M_imag {base_address 48 range 16} input1_M_real {base_address 64 range 64} input1_M_imag {base_address 128 range 64} input2_M_real {base_address 192 range 16} input2_M_imag {base_address 208 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 108 II x}

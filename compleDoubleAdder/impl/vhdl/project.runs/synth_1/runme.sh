...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/compleDoubleAdder/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complexDoubleAdder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source complexDoubleAdder.tcl

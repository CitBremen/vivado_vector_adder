...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/compleDoubleAdder/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log complexDoubleAdder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source complexDoubleAdder.tcl -notrace

...
set Library     "hls"
set IPName      "complexDoubleAdder"
set Version     "1.0"
set DisplayName "Complexdoubleadder"
set Revision    "1606011954"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "complexDoubleAdder"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "in1_M_real {base_address 64 range 64} in1_M_imag {base_address 128 range 64} in2_M_real {base_address 192 range 64} in2_M_imag {base_address 256 range 64} out_M_real {base_address 320 range 64} out_M_imag {base_address 384 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 15 II x}

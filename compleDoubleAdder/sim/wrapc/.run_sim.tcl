...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "complexDoubleAdder.autotvin.dat"
	set constFileTvOut       "complexDoubleAdder.autotvout.dat"
	set constFileHdlTvIn     "complexDoubleAdder.autohdltvin.dat"
	set constFileHdlTvOut    "complexDoubleAdder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

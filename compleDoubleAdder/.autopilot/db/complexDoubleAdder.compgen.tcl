...
set id 0
set name complexDoubleAdder_dadd_64ns_64ns_64_5_full_dsp
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 2 \
			corename complexDoubleAdder_AXILiteS_axilite \
			name complexDoubleAdder_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler complexDoubleAdder_AXILiteS_s_axi
}

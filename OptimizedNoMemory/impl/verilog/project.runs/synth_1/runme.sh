...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/OptimizedNoMemory/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopAdder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TopAdder.tcl

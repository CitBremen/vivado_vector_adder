...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/OptimizedNoMemory/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopAdder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source TopAdder.tcl -notrace

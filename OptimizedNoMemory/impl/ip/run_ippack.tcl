...
set IPName      "TopAdder"
set Version     "1.0"
set DisplayName "Topadder"
set Revision    "1605212350"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "output_M_real {base_address 32 range 16} output_M_imag {base_address 48 range 16} input1_M_real_0 {base_address 64 range 32} input1_M_real_1 {base_address 96 range 32} input1_M_real_2 {base_address 128 range 32} input1_M_imag_0 {base_address 160 range 32} input1_M_imag_1 {base_address 192 range 32} input1_M_imag_2 {base_address 224 range 32} input2_M_real {base_address 256 range 16} input2_M_imag {base_address 272 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
set enable_xo_gen 0
set kernel_files {C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/adder.cpp}
if {$enable_xo_gen} {

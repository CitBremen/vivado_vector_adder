...
u32 XTopadder_Get_input1_M_real_0_BaseAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE);
}
...
u32 XTopadder_Get_input1_M_real_0_HighAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_HIGH);
}
...
u32 XTopadder_Get_input1_M_real_0_TotalBytes(XTopadder *InstancePtr) {
    ...
    return (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + 1);
}
...
u32 XTopadder_Get_input1_M_real_0_BitWidth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_WIDTH_INPUT1_M_REAL_0;
}
...
u32 XTopadder_Get_input1_M_real_0_Depth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_DEPTH_INPUT1_M_REAL_0;
}
...
u32 XTopadder_Write_input1_M_real_0_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    if ((offset + length)*4 > (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_real_0_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XTopadder_Write_input1_M_real_0_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_real_0_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_0_BASE + offset + i);
    }
    return length;
}
...
u32 XTopadder_Get_input1_M_real_1_BaseAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE);
}
...
u32 XTopadder_Get_input1_M_real_1_HighAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_HIGH);
}
...
u32 XTopadder_Get_input1_M_real_1_TotalBytes(XTopadder *InstancePtr) {
    ...
    return (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + 1);
}
...
u32 XTopadder_Get_input1_M_real_1_BitWidth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_WIDTH_INPUT1_M_REAL_1;
}
...
u32 XTopadder_Get_input1_M_real_1_Depth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_DEPTH_INPUT1_M_REAL_1;
}
...
u32 XTopadder_Write_input1_M_real_1_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    if ((offset + length)*4 > (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_real_1_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XTopadder_Write_input1_M_real_1_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_real_1_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_1_BASE + offset + i);
    }
    return length;
}
...
u32 XTopadder_Get_input1_M_real_2_BaseAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE);
}
...
u32 XTopadder_Get_input1_M_real_2_HighAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_HIGH);
}
...
u32 XTopadder_Get_input1_M_real_2_TotalBytes(XTopadder *InstancePtr) {
    ...
    return (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + 1);
}
...
u32 XTopadder_Get_input1_M_real_2_BitWidth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_WIDTH_INPUT1_M_REAL_2;
}
...
u32 XTopadder_Get_input1_M_real_2_Depth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_DEPTH_INPUT1_M_REAL_2;
}
...
u32 XTopadder_Write_input1_M_real_2_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    if ((offset + length)*4 > (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_real_2_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XTopadder_Write_input1_M_real_2_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_real_2_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_REAL_2_BASE + offset + i);
    }
    return length;
}
...
u32 XTopadder_Get_input1_M_imag_0_BaseAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE);
}
...
u32 XTopadder_Get_input1_M_imag_0_HighAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_HIGH);
}
...
u32 XTopadder_Get_input1_M_imag_0_TotalBytes(XTopadder *InstancePtr) {
    ...
    return (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + 1);
}
...
u32 XTopadder_Get_input1_M_imag_0_BitWidth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_WIDTH_INPUT1_M_IMAG_0;
}
...
u32 XTopadder_Get_input1_M_imag_0_Depth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_DEPTH_INPUT1_M_IMAG_0;
}
...
u32 XTopadder_Write_input1_M_imag_0_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    if ((offset + length)*4 > (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_imag_0_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XTopadder_Write_input1_M_imag_0_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_imag_0_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_0_BASE + offset + i);
    }
    return length;
}
...
u32 XTopadder_Get_input1_M_imag_1_BaseAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE);
}
...
u32 XTopadder_Get_input1_M_imag_1_HighAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_HIGH);
}
...
u32 XTopadder_Get_input1_M_imag_1_TotalBytes(XTopadder *InstancePtr) {
    ...
    return (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + 1);
}
...
u32 XTopadder_Get_input1_M_imag_1_BitWidth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_WIDTH_INPUT1_M_IMAG_1;
}
...
u32 XTopadder_Get_input1_M_imag_1_Depth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_DEPTH_INPUT1_M_IMAG_1;
}
...
u32 XTopadder_Write_input1_M_imag_1_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    if ((offset + length)*4 > (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_imag_1_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XTopadder_Write_input1_M_imag_1_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_imag_1_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_1_BASE + offset + i);
    }
    return length;
}
...
u32 XTopadder_Get_input1_M_imag_2_BaseAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE);
}
...
u32 XTopadder_Get_input1_M_imag_2_HighAddress(XTopadder *InstancePtr) {
    ...
    return (InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_HIGH);
}
...
u32 XTopadder_Get_input1_M_imag_2_TotalBytes(XTopadder *InstancePtr) {
    ...
    return (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + 1);
}
...
u32 XTopadder_Get_input1_M_imag_2_BitWidth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_WIDTH_INPUT1_M_IMAG_2;
}
...
u32 XTopadder_Get_input1_M_imag_2_Depth(XTopadder *InstancePtr) {
    ...
    return XTOPADDER_AXILITES_DEPTH_INPUT1_M_IMAG_2;
}
...
u32 XTopadder_Write_input1_M_imag_2_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    if ((offset + length)*4 > (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_imag_2_Words(XTopadder *InstancePtr, int offset, int *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XTopadder_Write_input1_M_imag_2_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_HIGH - XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XTopadder_Read_input1_M_imag_2_Bytes(XTopadder *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Axilites_BaseAddress + XTOPADDER_AXILITES_ADDR_INPUT1_M_IMAG_2_BASE + offset + i);
    }
    return length;
}

...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.complexDoubleAdder.autotvin_in1_M_real.dat"
         "c.complexDoubleAdder.autotvin_in1_M_imag.dat"
         "c.complexDoubleAdder.autotvin_in2_M_real.dat"
         "c.complexDoubleAdder.autotvin_in2_M_imag.dat"
         "c.complexDoubleAdder.autotvout_out_M_real.dat"
         "c.complexDoubleAdder.autotvout_out_M_imag.dat"
         "c.complexDoubleAdder.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.complexDoubleAdder.autotvout_out_M_real.dat"
         "rtl.complexDoubleAdder.autotvout_out_M_imag.dat"
         "rtl.complexDoubleAdder.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

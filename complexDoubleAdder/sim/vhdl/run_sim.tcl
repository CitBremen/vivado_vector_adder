...
if {[file isfile complexDoubleAdder.autotvin.dat]} {
	file delete -force complexDoubleAdder.autotvin.dat
}

if {[file isfile complexDoubleAdder.autotvout.dat]} {
	file delete -force complexDoubleAdder.autotvout.dat
}

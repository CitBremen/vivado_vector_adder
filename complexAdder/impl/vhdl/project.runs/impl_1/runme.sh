...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/complexAdder/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log complexAdder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source complexAdder.tcl -notrace

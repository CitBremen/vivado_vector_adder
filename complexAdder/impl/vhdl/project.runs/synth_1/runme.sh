...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/complexAdder/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complexAdder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source complexAdder.tcl

...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.complexAdder.autotvin_in1_M_real_V.dat"
         "c.complexAdder.autotvin_in1_M_imag_V.dat"
         "c.complexAdder.autotvin_in2_M_real_V.dat"
         "c.complexAdder.autotvin_in2_M_imag_V.dat"
         "c.complexAdder.autotvout_out_M_real_V.dat"
         "c.complexAdder.autotvout_out_M_imag_V.dat"
         "c.complexAdder.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.complexAdder.autotvout_out_M_real_V.dat"
         "rtl.complexAdder.autotvout_out_M_imag_V.dat"
         "rtl.complexAdder.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

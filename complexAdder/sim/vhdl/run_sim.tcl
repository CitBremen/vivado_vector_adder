...
if {[file isfile complexAdder.autotvin.dat]} {
	file delete -force complexAdder.autotvin.dat
}

if {[file isfile complexAdder.autotvout.dat]} {
	file delete -force complexAdder.autotvout.dat
}

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "complexAdder.autotvin.dat"
	set constFileTvOut       "complexAdder.autotvout.dat"
	set constFileHdlTvIn     "complexAdder.autohdltvin.dat"
	set constFileHdlTvOut    "complexAdder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

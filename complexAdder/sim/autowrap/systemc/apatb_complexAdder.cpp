...
#define AUTOTB_TVIN_in1_M_real_V  "../tv/cdatafile/c.complexAdder.autotvin_in1_M_real_V.dat"
// wrapc file define: "in1_M_imag_V"
#define AUTOTB_TVIN_in1_M_imag_V  "../tv/cdatafile/c.complexAdder.autotvin_in1_M_imag_V.dat"
// wrapc file define: "in2_M_real_V"
#define AUTOTB_TVIN_in2_M_real_V  "../tv/cdatafile/c.complexAdder.autotvin_in2_M_real_V.dat"
// wrapc file define: "in2_M_imag_V"
#define AUTOTB_TVIN_in2_M_imag_V  "../tv/cdatafile/c.complexAdder.autotvin_in2_M_imag_V.dat"
// wrapc file define: "out_M_real_V"
#define AUTOTB_TVOUT_out_M_real_V  "../tv/cdatafile/c.complexAdder.autotvout_out_M_real_V.dat"
// wrapc file define: "out_M_imag_V"
#define AUTOTB_TVOUT_out_M_imag_V  "../tv/cdatafile/c.complexAdder.autotvout_out_M_imag_V.dat"
// wrapc file define: "ap_return"
#define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.complexAdder.autotvout_ap_return.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "out_M_real_V"
#define AUTOTB_TVOUT_PC_out_M_real_V  "../tv/rtldatafile/rtl.complexAdder.autotvout_out_M_real_V.dat"
// tvout file define: "out_M_imag_V"
#define AUTOTB_TVOUT_PC_out_M_imag_V  "../tv/rtldatafile/rtl.complexAdder.autotvout_out_M_imag_V.dat"
// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.complexAdder.autotvout_ap_return.dat"
...
#define complexAdder AESL_ORIG_DUT_complexAdder
...
std::complex<ap_fixed<32, 8, (ap_q_mode) 5, (ap_o_mode)3, 0> > out[3])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *out_M_real_V_pc_buffer = new sc_bv<32>[3];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_M_real_V
				{
					...
					// {
						...
						// {
							sc_lv<32>* out__M_real_V_lv0_0_2_1 = new sc_lv<32>[3];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: out._M_real.V(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 2; i_0 += 1)
							{
								...
								{
									out__M_real_V_lv0_0_2_1[hls_map_index++].range(31, 0) = sc_bv<32>(out_M_real_V_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: out._M_real.V(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 2; i_0 += 1)
							{
								...
								// output_type_conversion : (out__M_real_V_lv0_0_2_1[hls_map_index++]).to_string(SC_BIN).c_str()
								if (&(out[0].real()) != NULL) // check the null address if the c port is array or others
								{
									(out[i_0].real()).range() = (out__M_real_V_lv0_0_2_1[hls_map_index++]).to_string(SC_BIN).c_str();
								}
							}
						}
					}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *out_M_imag_V_pc_buffer = new sc_bv<32>[3];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_M_imag_V
				{
					...
					// {
						...
						// {
							sc_lv<32>* out__M_imag_V_lv0_0_2_1 = new sc_lv<32>[3];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: out._M_imag.V(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 2; i_0 += 1)
							{
								...
								{
									out__M_imag_V_lv0_0_2_1[hls_map_index++].range(31, 0) = sc_bv<32>(out_M_imag_V_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: out._M_imag.V(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 2; i_0 += 1)
							{
								...
								// output_type_conversion : (out__M_imag_V_lv0_0_2_1[hls_map_index++]).to_string(SC_BIN).c_str()
								if (&(out[0].imag()) != NULL) // check the null address if the c port is array or others
								{
									(out[i_0].imag()).range() = (out__M_imag_V_lv0_0_2_1[hls_map_index++]).to_string(SC_BIN).c_str();
								}
							}
						}
					}
	...
	else
	{
		...
		sc_bv<32>* in1_M_real_V_tvin_wrapc_buffer = new sc_bv<32>[3];
		...
		tcl_file.set_num(3, &tcl_file.in1_M_real_V_depth);
		...
		sc_bv<32>* in1_M_imag_V_tvin_wrapc_buffer = new sc_bv<32>[3];
		...
		tcl_file.set_num(3, &tcl_file.in1_M_imag_V_depth);
		...
		sc_bv<32>* in2_M_real_V_tvin_wrapc_buffer = new sc_bv<32>[3];
			...
			// bitslice(31, 0)
			{
				...
				// celement: in2._M_real.V(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 2; i_0 += 1)
					{
						...
						// input_type_conversion : (in2[i_0].real()).range().to_string(SC_BIN).c_str()
						if (&(in2[0].real()) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> in2__M_real_V_tmp_mem;
							in2__M_real_V_tmp_mem = (in2[i_0].real()).range().to_string(SC_BIN).c_str();
		...
		tcl_file.set_num(3, &tcl_file.in2_M_real_V_depth);
		...
		sc_bv<32>* in2_M_imag_V_tvin_wrapc_buffer = new sc_bv<32>[3];
			...
			// bitslice(31, 0)
			{
				...
				// celement: in2._M_imag.V(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 2; i_0 += 1)
					{
						...
						// input_type_conversion : (in2[i_0].imag()).range().to_string(SC_BIN).c_str()
						if (&(in2[0].imag()) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> in2__M_imag_V_tmp_mem;
							in2__M_imag_V_tmp_mem = (in2[i_0].imag()).range().to_string(SC_BIN).c_str();
		...
		tcl_file.set_num(3, &tcl_file.in2_M_imag_V_depth);
...
// [call_c_dut] ---------->
		...
		int AESL_return = AESL_ORIG_DUT_complexAdder(in1, in2, out);
		...
		sc_bv<32>* out_M_real_V_tvout_wrapc_buffer = new sc_bv<32>[3];
		...
		tcl_file.set_num(3, &tcl_file.out_M_real_V_depth);
		...
		sc_bv<32>* out_M_imag_V_tvout_wrapc_buffer = new sc_bv<32>[3];
		...
		tcl_file.set_num(3, &tcl_file.out_M_imag_V_depth);

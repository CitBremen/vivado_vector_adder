...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.floatAdder.autotvin_in1_V.dat"
         "c.floatAdder.autotvin_in2_V.dat"
         "c.floatAdder.autotvout_out_V.dat"
         "c.floatAdder.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.floatAdder.autotvout_out_V.dat"
         "rtl.floatAdder.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
if {[file isfile floatAdder.autotvin.dat]} {
	file delete -force floatAdder.autotvin.dat
}

if {[file isfile floatAdder.autotvout.dat]} {
	file delete -force floatAdder.autotvout.dat
}

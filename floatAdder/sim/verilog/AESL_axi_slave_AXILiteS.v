...
//------------------------Parameter----------------------
`define TV_IN_in1_V "../tv/cdatafile/c.floatAdder.autotvin_in1_V.dat"
`define TV_IN_in2_V "../tv/cdatafile/c.floatAdder.autotvin_in2_V.dat"
`define TV_OUT_out_V "../tv/rtldatafile/rtl.floatAdder.autotvout_out_V.dat"
`define TV_OUT_ap_return "../tv/rtldatafile/rtl.floatAdder.autotvout_ap_return.dat"
parameter ADDR_WIDTH = 7;
parameter DATA_WIDTH = 32;
parameter in1_V_DEPTH = 3;
reg [31 : 0] in1_V_OPERATE_DEPTH = 0;
parameter in1_V_c_bitwidth = 18;
parameter in2_V_DEPTH = 3;
reg [31 : 0] in2_V_OPERATE_DEPTH = 0;
parameter in2_V_c_bitwidth = 18;
parameter out_V_DEPTH = 3;
reg [31 : 0] out_V_OPERATE_DEPTH = 0;
parameter out_V_c_bitwidth = 18;
parameter ap_return_DEPTH = 1;
reg [31 : 0] ap_return_OPERATE_DEPTH = 0;
parameter ap_return_c_bitwidth = 32;
parameter START_ADDR = 0;
parameter floatAdder_continue_addr = 0;
parameter floatAdder_auto_start_addr = 0;
parameter in1_V_data_in_addr = 32;
parameter in2_V_data_in_addr = 48;
parameter ap_return_data_out_addr = 16;
parameter out_V_data_out_addr = 64;
...
reg  BREADY_reg = 0;
reg [DATA_WIDTH - 1 : 0] mem_in1_V [in1_V_DEPTH - 1 : 0];
reg in1_V_write_data_finish;
reg [DATA_WIDTH - 1 : 0] mem_in2_V [in2_V_DEPTH - 1 : 0];
reg in2_V_write_data_finish;
reg [DATA_WIDTH - 1 : 0] mem_out_V [out_V_DEPTH - 1 : 0];
reg out_V_read_data_finish;
...
//write in1_V reg
reg [31 : 0] write_in1_V_count = 0;
reg write_in1_V_run_flag = 0;
reg write_one_in1_V_data_done = 0;
//write in2_V reg
reg [31 : 0] write_in2_V_count = 0;
reg write_in2_V_run_flag = 0;
reg write_one_in2_V_data_done = 0;
//read out_V reg
reg [31 : 0] read_out_V_count = 0;
reg read_out_V_run_flag = 0;
reg read_one_out_V_data_done = 0;
//read ap_return reg
...
assign TRAN_AXILiteS_read_data_finish = 1 & out_V_read_data_finish & ap_return_read_data_finish;
assign TRAN_AXILiteS_write_data_finish = 1 & in1_V_write_data_finish & in2_V_write_data_finish;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        in1_V_write_data_finish <= 0;
        write_in1_V_run_flag <= 0; 
        write_in1_V_count = 0;
        count_operate_depth_by_bitwidth_and_depth (in1_V_c_bitwidth, in1_V_DEPTH, in1_V_OPERATE_DEPTH);
    end
    else begin
        ...
        if (AESL_ready_reg === 1) begin
            write_in1_V_run_flag <= 1; 
            write_in1_V_count = 0;
        end
        if (write_one_in1_V_data_done === 1) begin
            write_in1_V_count = write_in1_V_count + 1;
            if (write_in1_V_count == in1_V_OPERATE_DEPTH) begin
                write_in1_V_run_flag <= 0; 
                in1_V_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_in1_V
    integer write_in1_V_resp;
    integer process_num ;
    integer get_ack;
    ...
    integer i;
    integer j;
    reg [31 : 0] in1_V_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = in1_V_c_bitwidth;
    process_num = 1;
    ...
    while (1) begin
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_in1_V_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write in1_V data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (in1_V_c_bitwidth < 32) begin
                        in1_V_data_tmp_reg = mem_in1_V[write_in1_V_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < in1_V_c_bitwidth) begin
                                in1_V_data_tmp_reg[j] = mem_in1_V[write_in1_V_count][i*32 + j];
                            end
                            else begin
                                in1_V_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    write (in1_V_data_in_addr + write_in1_V_count * four_byte_num * 4 + i * 4, in1_V_data_tmp_reg, write_in1_V_resp);
                end
                process_busy = 0;
                write_one_in1_V_data_done <= 1;
                @(posedge clk);
                write_one_in1_V_data_done <= 0;
            end   
            process_1_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        in2_V_write_data_finish <= 0;
        write_in2_V_run_flag <= 0; 
        write_in2_V_count = 0;
        count_operate_depth_by_bitwidth_and_depth (in2_V_c_bitwidth, in2_V_DEPTH, in2_V_OPERATE_DEPTH);
    end
    else begin
        if (TRAN_AXILiteS_start_in === 1) begin
            in2_V_write_data_finish <= 0;
        ...
        if (AESL_ready_reg === 1) begin
            write_in2_V_run_flag <= 1; 
            write_in2_V_count = 0;
        end
        if (write_one_in2_V_data_done === 1) begin
            write_in2_V_count = write_in2_V_count + 1;
            if (write_in2_V_count == in2_V_OPERATE_DEPTH) begin
                write_in2_V_run_flag <= 0; 
                in2_V_write_data_finish <= 1;
            end
        end
    end
end

initial begin : write_in2_V
    integer write_in2_V_resp;
    integer process_num ;
    integer get_ack;
    integer four_byte_num;
    integer c_bitwidth;
    integer i;
    integer j;
    reg [31 : 0] in2_V_data_tmp_reg;
    wait(reset === 1);
    @(posedge clk);
    c_bitwidth = in2_V_c_bitwidth;
    process_num = 2;
    count_c_data_four_byte_num_by_bitwidth (c_bitwidth , four_byte_num) ;
    while (1) begin
        process_2_finish <= 0;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            get_ack = 1;
            if (write_in2_V_run_flag === 1 && get_ack === 1) begin
                process_busy = 1;
                //write in2_V data 
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (in2_V_c_bitwidth < 32) begin
                        in2_V_data_tmp_reg = mem_in2_V[write_in2_V_count];
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < in2_V_c_bitwidth) begin
                                in2_V_data_tmp_reg[j] = mem_in2_V[write_in2_V_count][i*32 + j];
                            end
                            else begin
                                in2_V_data_tmp_reg[j] = 0;
                            end
                        end
                    end
                    write (in2_V_data_in_addr + write_in2_V_count * four_byte_num * 4 + i * 4, in2_V_data_tmp_reg, write_in2_V_resp);
                end
                process_busy = 0;
                write_one_in2_V_data_done <= 1;
                @(posedge clk);
                write_one_in2_V_data_done <= 0;
            end   
            process_2_finish <= 1;
        end
        @(posedge clk);
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        out_V_read_data_finish <= 0;
        read_out_V_run_flag <= 0; 
        read_out_V_count = 0;
        count_operate_depth_by_bitwidth_and_depth (out_V_c_bitwidth, out_V_DEPTH, out_V_OPERATE_DEPTH);
    end
    else begin
        if (AESL_done_index_reg === 1) begin
            read_out_V_run_flag = 1; 
        end
        if (TRAN_AXILiteS_transaction_done_in === 1) begin
            out_V_read_data_finish <= 0;
            read_out_V_count = 0; 
        end
        if (read_one_out_V_data_done === 1) begin
            read_out_V_count = read_out_V_count + 1;
            if (read_out_V_count == out_V_OPERATE_DEPTH) begin
                read_out_V_run_flag <= 0; 
                out_V_read_data_finish <= 1;
            end
        end
    end
end

initial begin : read_out_V
    integer read_out_V_resp;
    integer process_num;
    integer get_vld;
    integer four_byte_num;
    integer c_bitwidth;
    ...
    while (1) begin
        process_4_finish <= 0;
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            if (read_out_V_run_flag === 1) begin
                process_busy = 1;
                get_vld = 1;
                if (get_vld == 1) begin
                    //read out_V data 
                    for (i = 0 ; i < four_byte_num ; i = i+1) begin
                        read (out_V_data_out_addr + read_out_V_count * four_byte_num * 4 + i * 4, RDATA_reg, read_out_V_resp);
                        if (out_V_c_bitwidth < 32) begin
                            mem_out_V[read_out_V_count] <= RDATA_reg;
                        end
                        else begin
                            for (j=0 ; j < 32 ; j = j + 1) begin
                                if (i*32 + j < out_V_c_bitwidth) begin
                                    mem_out_V[read_out_V_count][i*32 + j] <= RDATA_reg[j];
                                end
                            end
                        end
                    end
                    
                    read_one_out_V_data_done <= 1;
                    @(posedge clk);
                    read_one_out_V_data_done <= 0;
                end    
                process_busy = 0;
            end    
            process_4_finish <= 1;
...
// Read data from file 
initial begin : read_in1_V_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [in1_V_c_bitwidth - 1 : 0] token_tmp; 
  ...
  count_seperate_factor_by_bitwidth (in1_V_c_bitwidth , factor);
  fp = $fopen(`TV_IN_in1_V ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_in1_V); 
      $finish; 
  end 
  read_token(fp, token); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < in1_V_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
...
// Read data from file 
initial begin : read_in2_V_file_process 
  integer fp; 
  integer ret; 
  integer factor; 
  reg [127 : 0] token; 
  reg [in2_V_c_bitwidth - 1 : 0] token_tmp; 
  reg [DATA_WIDTH - 1 : 0] mem_tmp; 
  reg [ 8*5 : 1] str;
  integer transaction_idx; 
  integer i; 
  transaction_idx = 0; 
  mem_tmp [DATA_WIDTH - 1 : 0] = 0;
  count_seperate_factor_by_bitwidth (in2_V_c_bitwidth , factor);
  fp = $fopen(`TV_IN_in2_V ,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_in2_V); 
      $finish; 
  end 
  read_token(fp, token); 
  if (token != "[[[runtime]]]") begin             // Illegal format 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      for(i = 0; i < in2_V_DEPTH; i = i + 1) begin 
          read_token(fp, token); 
          ret = $sscanf(token, "0x%x", token_tmp); 
          if (factor == 4) begin
              if (i%factor == 0) begin
...
initial begin : write_out_V_file_proc 
  integer fp; 
  integer factor; 
  integer transaction_idx; 
  reg [out_V_c_bitwidth - 1 : 0] mem_tmp; 
  reg [ 100*8 : 1] str;
  integer i; 
  transaction_idx = 0; 
  count_seperate_factor_by_bitwidth (out_V_c_bitwidth , factor);
  while(1) begin 
      @(posedge clk);
      while (out_V_read_data_finish !== 1) begin
          @(posedge clk);
      end
      # 0.1;
      ...
      for (i = 0; i < (out_V_DEPTH - out_V_DEPTH % factor); i = i + 1) begin
          if (factor == 4) begin
              if (i%factor == 0) begin
                  mem_tmp = mem_out_V[i/factor][7:0];
              end
              if (i%factor == 1) begin
                  mem_tmp = mem_out_V[i/factor][15:8];
              end
              if (i%factor == 2) begin
                  mem_tmp = mem_out_V[i/factor][23:16];
              end
              if (i%factor == 3) begin
                  mem_tmp = mem_out_V[i/factor][31:24];
              end
              $fdisplay(fp,"0x%x",mem_tmp);
          end
          if (factor == 2) begin
              if (i%factor == 0) begin
                  mem_tmp = mem_out_V[i/factor][15:0];
              end
              if (i%factor == 1) begin
                  mem_tmp = mem_out_V[i/factor][31:16];
              end
              $fdisplay(fp,"0x%x",mem_tmp);
          end
          if (factor == 1) begin
              $fdisplay(fp,"0x%x",mem_out_V[i]);
          end
      end 
      if (factor == 4) begin
          if ((out_V_DEPTH - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][7:0]);
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][15:8]);
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][23:16]);
          end
          if ((out_V_DEPTH - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][7:0]);
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][15:8]);
          end
          if ((out_V_DEPTH - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][7:0]);
          end
      end
      if (factor == 2) begin
          if ((out_V_DEPTH - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",mem_out_V[out_V_DEPTH / factor][15:0]);
          end
      end

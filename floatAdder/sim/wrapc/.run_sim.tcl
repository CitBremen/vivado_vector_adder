...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "floatAdder.autotvin.dat"
	set constFileTvOut       "floatAdder.autotvout.dat"
	set constFileHdlTvIn     "floatAdder.autohdltvin.dat"
	set constFileHdlTvOut    "floatAdder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

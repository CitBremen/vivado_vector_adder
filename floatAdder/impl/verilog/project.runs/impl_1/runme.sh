...
HD_PWD='C:/Users/engrm_000/OneDrive/vivado_HLS/complexAdder/floatAdder/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log floatAdder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source floatAdder.tcl -notrace

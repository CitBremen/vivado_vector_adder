...
set Library     "hls"
set IPName      "complex2DAdder"
set Version     "1.0"
set DisplayName "Complex2dadder"
set Revision    "1606092342"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "complex2DAdder"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "in1_M_real_V {base_address 32 range 32} in1_M_imag_V {base_address 64 range 32} in2_M_real_V {base_address 128 range 64} in2_M_imag_V {base_address 192 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS out_M_real_V out_M_imag_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"

...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("out_M_real_V_TDATA", 32, hls_out, 4, "axis", "out_data", 1),
	Port_Property("out_M_real_V_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("out_M_real_V_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
	Port_Property("out_M_imag_V_TDATA", 32, hls_out, 5, "axis", "out_data", 1),
	Port_Property("out_M_imag_V_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("out_M_imag_V_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "complex2DAdder";

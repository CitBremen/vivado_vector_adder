...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "complex2DAdder.autotvin.dat"
	set constFileTvOut       "complex2DAdder.autotvout.dat"
	set constFileHdlTvIn     "complex2DAdder.autohdltvin.dat"
	set constFileHdlTvOut    "complex2DAdder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
if {[file isfile complex2DAdder.autotvin.dat]} {
	file delete -force complex2DAdder.autotvin.dat
}

if {[file isfile complex2DAdder.autotvout.dat]} {
	file delete -force complex2DAdder.autotvout.dat
}

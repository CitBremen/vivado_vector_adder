...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.complex2DAdder.autotvin_in1_M_real_V.dat"
         "c.complex2DAdder.autotvin_in1_M_imag_V.dat"
         "c.complex2DAdder.autotvin_in2_M_real_V.dat"
         "c.complex2DAdder.autotvin_in2_M_imag_V.dat"
         "c.complex2DAdder.autotvin_out_M_real_V.dat"
         "c.complex2DAdder.autotvin_out_M_imag_V.dat"
         "c.complex2DAdder.autotvout_out_M_real_V.dat"
         "c.complex2DAdder.autotvout_out_M_imag_V.dat"
         "c.complex2DAdder.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.complex2DAdder.autotvout_out_M_real_V.dat"
         "rtl.complex2DAdder.autotvout_out_M_imag_V.dat"
         "rtl.complex2DAdder.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
